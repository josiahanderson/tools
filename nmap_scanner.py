...
The disadvantage is that the scanning is done sequentially and not
concurrently.
'''
...
def main():
    ...
    for host in hosts:
        scan_results = scan_top_ports(host)
        print_scan_results(host, scan_results, "Top Ports Scan")
        
    for host in hosts:
        scan_results = scan_all_ports(host)
        print_scan_results(host, scan_results, "All Ports Scan")

        scan_results = scan_in_depth(host, scan_results)
        print_scan_results(host, scan_results, "Service Scan")
